			...
			<Group header={<Header mode="secondary">Описание</Header>}>
				...
				<Div>
					<Text weight="regular">
						...
						<br /><br />
						Топ-3 последователей получили награды за наиболее значимый вклад в получение этого достижения, а отправленные гигантюры уже успели порадовать мастеров и игроков в разных уголках мира.
					</Text>
				</Div>
			</Group>
